    ...
    },
    {
      ...
      value: function render() {
        ...
        var _props6 = this.props,
          ...
          loadingElem = _props6.loadingElem,
          sorts = _props6.sorts,
          filters = _props6.filters,
          onFetchData = _props6.onFetchData;
        var forceEdit = this.state.forceEdit;

        var reactTableData = data.map(function (row) {
          return row.map(function (cell) {
            return cell.value;
          });
        });
        var reactTableColumns = data.map(function (column, j) {
          var firstCell = column[0];
          return _extends({}, firstCell, {
            Cell: function Cell(_ref4) {
              var row = _ref4.row,
                index = _ref4.index,
                columnProps = _ref4.columnProps;
...
DataSheet.propTypes = {
  ...
  sorts: _propTypes2.default.array.isRequired,
  isLoading: _propTypes2.default.bool.isRequired,
  loadingElem: _propTypes2.default.element.isRequired,
  numberOfPages: _propTypes2.default.number.isRequired,
};
